...
const [first, second] = pizzaToppings1;

console.log(first); // 'Rover'
console.log(second); // 'Snuffles'
...
console.log(car.make); // 'Alex'
console.log(car.model); // 'Software Engineer'
...
function Example(animal = "cat", color = "white") {
